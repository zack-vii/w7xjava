...
public interface JiVar{
    ...
    public Object read(JiDim[] dim) throws IOException;

    public byte[] readByte(JiDim[] dim) throws IOException;

    public char[] readChar(JiDim[] dim) throws IOException;

    public double[] readDouble(JiDim[] dim) throws IOException;

    public float[] readFloat(JiDim[] dim) throws IOException;

    public int[] readInt(JiDim[] dim) throws IOException;

    public short[] readShort(JiDim[] dim) throws IOException;
}
