...
public interface DataProvider{
     ...
     *
     * @param l
     *            The ConnectionListener which has to be notified by means of method processConnectionEvent(ConnenctionEvent)
     ...
     * @param event
     *            The name of the event for which the UpdateEventListener is registering.
     ...
     *
     * @param in_y
     *            Y axis specification as typed in the setup data source popupo dialog.
     * @param in_x
     *            X axis specification as typed in the setup data source popupo dialog.
     * @return The evaluated signal, embedded in a WaveData object, or null if an error is encountered.
     * @see WaveData
     */
     ...
     * -DataProvider.LOGIN_OK if the DataProvider has been succesfully validated <br>
