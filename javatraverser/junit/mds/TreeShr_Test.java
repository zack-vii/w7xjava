...
public class TreeShr_Test{
    ...
    public final void test000TreeOpenNew() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeOpenNew(TreeShr_Test.ctx, TreeShr_Test.expt, TreeShr_Test.model));
    ...
    public final void test090TreeClose() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeClose(TreeShr_Test.ctx, AllTests.tree, TreeShr_Test.model));
    }
    ...
    public final void test100TreeOpenEdit() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeOpenEdit(TreeShr_Test.ctx, TreeShr_Test.expt, TreeShr_Test.model));
    }

    @Test
    public final void test101TreeAddNode() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "A", TREENODE.USAGE_SIGNAL).status);
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "B", TREENODE.USAGE_SUBTREE).status);
    ...
    public final void test102TreeAddConglom() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeAddConglom(TreeShr_Test.ctx, "C", "E1429").status);
    }

    @Test
    public final void test103TreeManualConglomerate() throws MdsException {
        final int nid = 40;
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeStartConglomerate(TreeShr_Test.ctx, 11));
        Assert.assertEquals(nid, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "D", TREENODE.USAGE_DEVICE).data);
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeSetDefault(TreeShr_Test.ctx, nid));
        Assert.assertEquals(nid, TreeShr_Test.treeshr.treeGetDefaultNid(TreeShr_Test.ctx).data);
        Assert.assertEquals(nid + 1, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "ACTION", TREENODE.USAGE_ACTION).data);
        Assert.assertEquals(nid + 2, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "ANY", TREENODE.USAGE_ANY).data);
        Assert.assertEquals(nid + 3, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "AXIS", TREENODE.USAGE_AXIS).data);
        Assert.assertEquals(nid + 4, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "COMPOUND", TREENODE.USAGE_COMPOUND_DATA).data);
        Assert.assertEquals(nid + 5, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "DISPATCH", TREENODE.USAGE_DISPATCH).data);
        Assert.assertEquals(nid + 6, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "NUMERIC", TREENODE.USAGE_NUMERIC).data);
        Assert.assertEquals(nid + 7, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "SIGNAL", TREENODE.USAGE_SIGNAL).data);
        Assert.assertEquals(nid + 8, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "STRUCTURE", TREENODE.USAGE_STRUCTURE).data);
        Assert.assertEquals(nid + 9, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "TASK", TREENODE.USAGE_TASK).data);
        Assert.assertEquals(nid + 10, TreeShr_Test.treeshr.treeAddNode(TreeShr_Test.ctx, "TEXT", TREENODE.USAGE_TEXT).data);
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeEndConglomerate(TreeShr_Test.ctx));
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeSetDefault(TreeShr_Test.ctx, 0));
    }

    @Test
    public final void test110TreeWriteTree() throws MdsException {
        Assert.assertEquals(1, TreeShr_Test.treeshr.treeWriteTree(TreeShr_Test.ctx));
    }
    ...
    public final void test115TreeContext() throws MdsException {
        ...
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeOpen(null, AllTests.tree, TreeShr_Test.shot, true));
    ...
    public final void test123TreeDeleteNodeExecute() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeDeleteNodeExecute(TreeShr_Test.ctx));
    }

    @Test
    public final void test130TreeAddTag() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeAddTag(TreeShr_Test.ctx, 2, "DEVICE"));
    ...
    public final void test132TreeRemoveNodesTags() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeRemoveNodesTags(TreeShr_Test.ctx, 2));
    ...
    public final void test150TreeSetSubtree() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeSetSubtree(TreeShr_Test.ctx, 2));
    }

    @Test
    public final void test150TreeSetXNci() throws MdsException {
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treeSetXNci(TreeShr_Test.ctx, 1, "myattr", Function.$HBAR()));
    }

    @Test
    public final void test151TreeSetNoSubtree() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeSetNoSubtree(TreeShr_Test.ctx, 2));
    }
    ...
    public final void test160TreeQuit() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeQuitTree(TreeShr_Test.ctx));
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeOpen(TreeShr_Test.ctx, AllTests.tree, TreeShr_Test.shot, false));
    }

    @Test
    public final void test161TreeBeginTimestampedSegment() throws MdsException {
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treeBeginTimestampedSegment(TreeShr_Test.ctx, 1, new Float32Array(new float[3]), -1));
    }

    @Test
    public final void test162TreePutTimestampedSegment() throws MdsException {
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treePutTimestampedSegment(TreeShr_Test.ctx, 1, System.nanoTime(), new Float32Array(.1f, .2f, .3f)));
    }

    @Test
    public final void test163TreePutRecord() throws MdsException {
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treePutRecord(TreeShr_Test.ctx, 1, null));
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treePutRecord(TreeShr_Test.ctx, 41, new Action(new Nid(45), new Nid(49), null, null, null)));
    }
    ...
    public final void test164TreeMakeTimestampedSegment() throws MdsException {
        ...
        for(int i = 0; i < 10; i++)
            dim[i] = t0 + i * 1000000l;
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treeMakeTimestampedSegment(TreeShr_Test.ctx, 1, dim, new Float32Array(.0f, .1f, .2f, .3f, .4f, .5f, .6f, .7f, .8f, Float.NaN), -1, 9));
    }

    @Test
    public final void test165TreePutRow() throws MdsException {
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treePutRow(TreeShr_Test.ctx, 1, 1 << 10, 1000009000000l, new Float32Array(.9f)));
    }
    ...
    public final void test166TreeMakeSegment() throws MdsException {
        ...
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treeMakeTimestampedSegment(TreeShr_Test.ctx, 1, dim, new Float32Array(1.0f, 1.1f, 1.2f, 1.3f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f)));
        Assert.assertEquals(2, TreeShr_Test.treeshr.treeGetNumSegments(TreeShr_Test.ctx, 1).data);
        for(int i = 0; i < 10; i++)
            dim[i] = t0 + i * 1000000l + 10000000l;
        Assert.assertEquals(TreeShr_Test.success, TreeShr_Test.treeshr.treeMakeTimestampedSegment(TreeShr_Test.ctx, 1, dim, new Float32Array(2.0f, 2.1f, 2.2f, 2.3f, 2.4f, 2.5f, 2.6f, 2.7f, 2.8f, 2.9f)));
    ...
    public final void test183TreeTurnOff() throws MdsException {
        Assert.assertEquals(265392050, TreeShr_Test.treeshr.treeTurnOff(TreeShr_Test.ctx, 1));
    }

    @Test
    public final void test184TreeTurnOn() throws MdsException {
        Assert.assertEquals(265392050, TreeShr_Test.treeshr.treeTurnOn(TreeShr_Test.ctx, 1));
    }

    @Test
    public final void test185TreeSetNciItm() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeSetNciItm(TreeShr_Test.ctx, 1, true, 0x7FFFFFFF));
        Assert.assertEquals(0x7FFFFFFF, TreeShr_Test.mds.getInteger(TreeShr_Test.ctx, "GetNci(1,'GET_FLAGS')"));
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeSetNciItm(TreeShr_Test.ctx, 1, false, -0x10400 - 1));
    ...
    public final void test211TreeCompressDatafile() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeClose(TreeShr_Test.ctx, AllTests.tree, TreeShr_Test.shot));
    ...
    public final void test220TreeOpen() throws MdsException {
        Assert.assertEquals(TreeShr_Test.normal, TreeShr_Test.treeshr.treeOpen(TreeShr_Test.ctx, TreeShr_Test.expt, TreeShr_Test.model, true));
    }
