...
public class PXD114Setup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = 8467708531665974618L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice3.setChoiceItems(new String[]{"C1", "C2", "C3", "C4", "EXTERNAL", "EXTERNAL5"});
        ...
        deviceChoice1.setChoiceItems(new String[]{"50 Ohm", "1MOhm"});
        ...
        deviceChoice5.setChoiceItems(new String[]{"DC", "AC", "GND"});
        ...
        deviceChoice9.setChoiceItems(new String[]{"DC", "AC", "GND"});
        deviceChoice9.setUpdateIdentifier("");
        deviceChoice9.setIdentifier("");
        deviceChoice10.setChoiceIntValues(new int[]{(int)50, (int)1000000});
        ...
        deviceChoice10.setChoiceItems(new String[]{"50 Ohm", "1 MOhm"});
        ...
        deviceChoice12.setChoiceItems(new String[]{"DC", "AC", "GND"});
        deviceChoice12.setUpdateIdentifier("");
        deviceChoice12.setIdentifier("");
        deviceChoice13.setChoiceIntValues(new int[]{(int)50, (int)1000000});
        ...
        deviceChoice13.setChoiceItems(new String[]{"50 Ohm", "1 MOhm"});
        ...
        deviceChoice15.setChoiceItems(new String[]{"DC", "AC", "GND"});
        deviceChoice15.setUpdateIdentifier("");
        deviceChoice15.setIdentifier("");
        deviceChoice16.setChoiceIntValues(new int[]{(int)50, (int)1000000});
        ...
        deviceChoice16.setChoiceItems(new String[]{"50 Ohm", "1 MOhm"});
