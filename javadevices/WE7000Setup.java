 ...
 * @version 1.0
 */
public class WE7000Setup extends DeviceSetup{
    /**
     * 
     */
    private static final long serialVersionUID = -6200637334827854464L;
    ...
    private void jbInit() throws Exception {
        this.setWidth(530);
        this.setHeight(530);
        this.setDeviceType("WE7000");
        this.setDeviceProvider("localhost");
        this.setDeviceTitle("YOCOGAWA Rack");
        ...
        deviceButtons1.setMethods(new String[]{"init", "arm"});
