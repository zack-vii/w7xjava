...
public class RFXGClockSetup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = -684652252346027181L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice3.setChoiceItems(new String[]{"SINGLE SWITCH: TOGGLE", "SINGLE SWICH: HIGH PULSES", "SINGLE SWITCH: LOW PULSES", "DOUBLE SWITCH: TOGGLE", "DOUBLE SWICH: HIGH PULSES", "DOUBLE SWITCH: LOW PULSES"});
        ...
        deviceChoice4.setChoiceItems(new String[]{"EVENT", "TRIGGER RISING", "TRIGGER FALLING", "SOFTWARE"});
