...
public class TRCFSetup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = 2191375254528035666L;
    public TRCFSetup(JFrame parent){
        ...
        JScrollPane1.setBounds(2, 24, 581, 205);
        ...
        JScrollPane2.setBounds(2, 24, 581, 205);
        ...
        deviceChoice4.setChoiceIntValues(new int[]{(int)0, (int)1, (int)2, (int)3, (int)4, (int)5, (int)6, (int)7});
        ...
        deviceChoice2.setChoiceFloatValues(new float[]{(float)50000.0, (float)20000.0, (float)10000.0, (float)5000.0, (float)2000.0, (float)1000.0, (float)500.0, (float)200.0, (float)100.0});
        ...
        deviceChoice3.setChoiceIntValues(new int[]{(int)1, (int)2, (int)4, (int)8, (int)16});
    ...
    public TRCFSetup(String sTitle){
        this();
        setTitle(sTitle);
    }
