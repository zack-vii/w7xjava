 ...
 * @version 1.0
 */
public class WE800Setup extends DeviceSetup{
    /**
     * 
     */
    private static final long serialVersionUID = -8144569186913454437L;
    ...
    private void jbInit() throws Exception {
        this.setWidth(530);
        this.setHeight(530);
        this.setDeviceType("WE800");
        this.setDeviceProvider("localhost");
        this.setDeviceTitle("YOCOGAWA Rack 8 Slots");
