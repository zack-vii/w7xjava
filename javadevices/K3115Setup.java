...
public class K3115Setup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = 2661949699154423663L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice1.setChoiceItems(new String[]{"MASTER", "SLAVE"});
        ...
        deviceChoice2.setChoiceItems(new String[]{"CYCLIC", "ACYCLIC"});
        ...
        deviceChoice4.setChoiceFloatValues(new float[]{(float)10000.0, (float)5000.0, (float)2500.0, (float)1000.0, (float)500.0, (float)250.0, (float)100.0, (float)50.0});
        ...
        deviceChoice8.setChoiceItems(new String[]{"BIPOLAR", "UNIPOLAR"});
        ...
        deviceChoice9.setChoiceItems(new String[]{"AS IS", "VARIABLE"});
        ...
        deviceChoice10.setChoiceFloatValues(new float[]{(float)20.0, (float)10.0, (float)5.0});
        deviceChoice10.setOffsetNid(16);
        deviceChoice10.setLabelString("");
        deviceChoice10.setChoiceItems(new String[]{"20", "10", "5"});
        ...
        deviceChoice11.setChoiceItems(new String[]{"AS IS", "VARIABLE"});
        ...
        deviceChoice13.setChoiceFloatValues(new float[]{(float)20.0, (float)10.0, (float)5.0});
        deviceChoice13.setOffsetNid(23);
        deviceChoice13.setLabelString("");
        deviceChoice13.setChoiceItems(new String[]{"20", "10", "5"});
        ...
        deviceChoice14.setChoiceFloatValues(new float[]{(float)20.0, (float)10.0, (float)5.0});
        deviceChoice14.setOffsetNid(30);
        deviceChoice14.setLabelString("");
        deviceChoice14.setChoiceItems(new String[]{"20", "10", "5"});
        ...
        deviceChoice17.setChoiceItems(new String[]{"BIPOLAR", "UNIPOLAR"});
        ...
        deviceChoice18.setChoiceItems(new String[]{"20", "10", "5"});
        deviceChoice18.setLabelString("");
        deviceChoice18.setOffsetNid(9);
        deviceChoice18.setChoiceFloatValues(new float[]{(float)20.0, (float)10.0, (float)5.0});
        ...
        deviceChoice110.setChoiceItems(new String[]{"BIPOLAR", "UNIPOLAR"});
        ...
        deviceChoice111.setChoiceItems(new String[]{"AS IS", "VARIABLE"});
        ...
        deviceChoice112.setChoiceItems(new String[]{"20", "10", "5"});
        deviceChoice112.setLabelString("");
        deviceChoice112.setOffsetNid(37);
        deviceChoice112.setChoiceFloatValues(new float[]{(float)20.0, (float)10.0, (float)5.0});
        ...
        deviceChoice114.setChoiceItems(new String[]{"BIPOLAR", "UNIPOLAR"});
        ...
        deviceChoice115.setChoiceItems(new String[]{"20", "10", "5"});
        deviceChoice115.setLabelString("");
        deviceChoice115.setOffsetNid(44);
        deviceChoice115.setChoiceFloatValues(new float[]{(float)20.0, (float)10.0, (float)5.0});
        ...
        deviceButtons1.setMethods(new String[]{"INIT", "RESET"});
