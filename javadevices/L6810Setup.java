...
public class L6810Setup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = -4936280937168710010L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice4.setChoiceFloatValues(new float[]{(float)0.0, (float)20.0, (float)50.0, (float)100.0, (float)200.0, (float)500.0, (float)1000.0, (float)2000.0, (float)5000.0, (float)10000.0, (float)20000.0, (float)50000.0, (float)100000.0, (float)200000.0, (float)500000.0, (float)1000000.0, (float)2000000.0, (float)5000000.0});
        deviceChoice4.setConvert(false);
        deviceChoice4.setOffsetNid(3);
        deviceChoice4.setLabelString("Clock Frequency:");
        deviceChoice4.setChoiceItems(new String[]{"0", "20", "50", "100", "200", "500", "1E3", "2E3", "5E3", "10E3", "20E3", "50E3", "100E3", "200E3", "500E3", "1E6", "2E6", "5E6"});
        ...
        deviceChoice7.setChoiceItems(new String[]{"0.4096", "1.024", "2.048", "4.096", "10.24", "25.6", "51.2", "102.4"});
        deviceChoice7.setLabelString("Range: ");
        deviceChoice7.setOffsetNid(19);
        deviceChoice7.setConvert(false);
        deviceChoice7.setChoiceFloatValues(new float[]{(float)0.4096, (float)1.024, (float)2.048, (float)4.096, (float)10.24, (float)25.6, (float)51.2, (float)102.4});
        deviceChoice7.setChoiceIntValues(null);
        deviceChoice8.setIdentifier("");
        deviceChoice8.setUpdateIdentifier("");
        deviceChoice8.setChoiceItems(new String[]{"Non inverting input, DC coupled", "Non inverting input, AC coupled", "Inverting input, DC coupled", "Inverting input, AC coupled", "Double ended input, DC coupled", "Double ended input, AC coupled", "Internally grounded, DC coupled", "Internally grounded, AC coupled"});
        ...
        deviceChoice9.setChoiceItems(new String[]{"0.4096", "1.024", "2.048", "4.096", "10.24", "25.6", "51.2", "102.4"});
        deviceChoice9.setLabelString("Range: ");
        deviceChoice9.setOffsetNid(25);
        deviceChoice9.setConvert(false);
        deviceChoice9.setChoiceFloatValues(new float[]{(float)0.4096, (float)1.024, (float)2.048, (float)4.096, (float)10.24, (float)25.6, (float)51.2, (float)102.4});
        deviceChoice9.setChoiceIntValues(null);
        deviceChoice10.setIdentifier("");
        deviceChoice10.setUpdateIdentifier("");
        deviceChoice10.setChoiceItems(new String[]{"Non inverting input, DC coupled", "Non inverting input, AC coupled", "Inverting input, DC coupled", "Inverting input, AC coupled", "Double ended input, DC coupled", "Double ended input, AC coupled", "Internally grounded, DC coupled", "Internally grounded, AC coupled"});
        ...
        deviceChoice11.setChoiceItems(new String[]{"0.4096", "1.024", "2.048", "4.096", "10.24", "25.6", "51.2", "102.4"});
        deviceChoice11.setLabelString("Range: ");
        deviceChoice11.setOffsetNid(31);
        deviceChoice11.setConvert(false);
        deviceChoice11.setChoiceFloatValues(new float[]{(float)0.4096, (float)1.024, (float)2.048, (float)4.096, (float)10.24, (float)25.6, (float)51.2, (float)102.4});
        deviceChoice11.setChoiceIntValues(null);
        deviceChoice12.setIdentifier("");
        deviceChoice12.setUpdateIdentifier("");
        deviceChoice12.setChoiceItems(new String[]{"Non inverting input, DC coupled", "Non inverting input, AC coupled", "Inverting input, DC coupled", "Inverting input, AC coupled", "Double ended input, DC coupled", "Double ended input, AC coupled", "Internally grounded, DC coupled", "Internally grounded, AC coupled"});
        ...
        deviceChoice6.setChoiceFloatValues(new float[]{(float)0.4096, (float)1.024, (float)2.048, (float)4.096, (float)10.24, (float)25.6, (float)51.2, (float)102.4});
        deviceChoice6.setConvert(false);
        deviceChoice6.setOffsetNid(13);
        deviceChoice6.setLabelString("Range: ");
        deviceChoice6.setChoiceItems(new String[]{"0.4096", "1.024", "2.048", "4.096", "10.24", "25.6", "51.2", "102.4"});
        ...
        deviceChoice5.setChoiceItems(new String[]{"Non inverting input, DC coupled", "Non inverting input, AC coupled", "Inverting input, DC coupled", "Inverting input, AC coupled", "Double ended input, DC coupled", "Double ended input, AC coupled", "Internally grounded, DC coupled", "Internally grounded, AC coupled"});
