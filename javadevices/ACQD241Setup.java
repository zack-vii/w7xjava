...
public class ACQD241Setup extends DeviceSetup{
    /**
     * 
     */
    private static final long serialVersionUID = -8030332009626495421L;

    static public void main(final String args[]) {
        (new ACQD241Setup()).setVisible(true);
    }
    ...
    public ACQD241Setup(final JFrame parent){
        super(parent);
        this.initComponents();
    }

    public ACQD241Setup(final String sTitle){
        this();
        setTitle(sTitle);
    }
    ...
    private void initComponents() {
        ...
        // {{INIT_CONTROLS
        setDeviceTitle("Acqiris Digitizer Model DC241");
        setDeviceType("ACQD241");
