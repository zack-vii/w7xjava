...
public class LASER_RUSetup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = -2490187110974816667L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice1.setChoiceItems(new String[]{"EXTERNAL", "INTERNAL", "AUTOMATIC", "MANUAL"});
        ...
        deviceChoice2.setChoiceItems(new String[]{"LOCAL", "REMOTE"});
