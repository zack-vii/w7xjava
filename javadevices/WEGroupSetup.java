...
public class WEGroupSetup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = 719646826431609830L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice111115.setChoiceItems(new String[]{"DC", "AC", "GND"});
        ...
        deviceChoice111114.setChoiceIntValues(new int[]{(int)0, (int)500000, (int)1000000});
        ...
        deviceChoice111114.setChoiceItems(new String[]{"OFF", "500 KHz", "1 MHz"});
        ...
        deviceChoice11111111118.setChoiceItems(new String[]{"DC", "AC"});
        ...
        deviceChoice110.setChoiceIntValues(new int[]{(int)0, (int)20, (int)40, (int)80, (int)200, (int)400, (int)800, (int)2000, (int)4000, (int)8000, (int)20000, (int)40000});
        ...
        deviceChoice110.setChoiceItems(new String[]{"OFF", "20 Hz", "40 Hz", "80 Hz", "200 Hz", "400 Hz", "800 Hz", "2 kHz", "4 kHz", "8 kHz", "20 kHz", "40 kHz"});
        deviceChoice110.setUpdateIdentifier("");
        deviceChoice110.setIdentifier("");
        deviceChoice11111111119.setChoiceIntValues(new int[]{(int)0, (int)400, (int)4000, (int)40000, (int)100000});
        ...
        jLabel1.setText("     Coupling            Range                L.P. Filter        " + "    A. A. Filter                   Start                       End");
        jLabel2.setText("      Coupling          Range                     Filter         " + "               Offset                    Start                   " + "        End");
        ...
        jPanel1.add(jPanel2, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        jPanel2.add(deviceField1, null);
        jPanel2.add(deviceDispatch1, null);
        jPanel1.add(jPanel4, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        ...
        jPanel1.add(jPanel3, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        ...
        jPanel1.add(deviceButtons1, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    }
}