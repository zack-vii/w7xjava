...
public class RFXPulseSetup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = 801947376149647096L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice2.setChoiceItems(new String[]{"EVENT", "TRIGGER RISING", "TRIGGER FALLING", "SOFTWARE"});
        ...
        deviceChoice3.setChoiceItems(new String[]{"HIGH PULSE", "LOW PULSE", "SINGLE TOGGLE: INITIAL HIGH", "SINGLE TOGGLE: INITIAL LOW", "DOUBLE TOGGLE: INITIAL HIGH", "DOUBLE TOGGLE: INITIAL LOW"});
