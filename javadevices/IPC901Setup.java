...
public class IPC901Setup extends DeviceSetup{
     ...
     * 
     */
    private static final long serialVersionUID = 3188331633585997906L;
    ...
    private void jbInit() throws Exception {
        ...
        deviceChoice3.setChoiceItems(new String[]{"MEASURE", "CALIBRATION"});
        ...
        deviceChoice5.setChoiceIntValues(new int[]{(int)1, (int)2, (int)4, (int)8, (int)16, (int)32});
        deviceChoice5.setChoiceFloatValues(null);
        deviceChoice5.setOffsetNid(10);
        deviceChoice5.setLabelString("DAC Gain: ");
        deviceChoice5.setChoiceItems(new String[]{"1", "2", "4", "8", "16", "32"});
        ...
        deviceChoice4.setChoiceItems(new String[]{"PHASE_1", "PHASE_2"});
        deviceChoice4.setUpdateIdentifier("");
        deviceChoice4.setIdentifier("");
        deviceChoice7.setChoiceIntValues(null);
        deviceChoice7.setChoiceFloatValues(new float[]{(float)0.0, (float)2500.0, (float)5000.0, (float)10000.0, (float)25000.0, (float)50000.0});
        deviceChoice7.setOffsetNid(12);
        deviceChoice7.setLabelString("FIR Cut Off:");
        deviceChoice7.setChoiceItems(new String[]{"0", "2.5E3", "5E3", "10E3", "25E3", "50E3"});
        deviceChoice7.setUpdateIdentifier("");
        deviceChoice7.setIdentifier("");
        deviceChoice6.setChoiceIntValues(new int[]{(int)8, (int)16, (int)32});
        deviceChoice6.setChoiceFloatValues(null);
        deviceChoice6.setOffsetNid(13);
        deviceChoice6.setLabelString("FIR Window: ");
        deviceChoice6.setChoiceItems(new String[]{"8", "16", "32"});
        deviceChoice6.setUpdateIdentifier("");
        deviceChoice6.setIdentifier("");
        deviceChoice9.setChoiceIntValues(new int[]{(int)1, (int)2, (int)4, (int)8, (int)16, (int)32});
